    ...
    render() {
      ...
      return (
        <div id="main-content">
          <Container>
            <MetaTags>
              <title>Les projets et collectes solidaires - Onvataider.com</title>
              ...
              <meta property="og:title" content="Les projets et collectes solidaires - Onvataider.com" />
            ...
            <div className="row">
              <div className="form-group col-md-12">
                ...
                <div className="btn-group" style={{ maxWidth: '100%', overflowX: 'auto' }}>
                  {categories && categories.map(row => <Link className="btn btn-primary btn-sm" key={row._id} to={`/projets-collectes/${row.url}`}>{row.name}</Link>)}
                  <Link className="btn btn-primary btn-sm" to="/projets-collectes">Aucun</Link>
                </div>
              </div>
